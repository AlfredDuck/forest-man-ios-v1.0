...
- (void)createUIPart
{
    ...
    signupButton.tintColor = [colorManager yellowText];
    signupButton.layer.masksToBounds = YES;
    signupButton.layer.cornerRadius = 8;
    signupButton.backgroundColor = [colorManager lightYellowBackground];
    ...
    label1.textColor = [colorManager lightTextColor];
